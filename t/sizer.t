...
foreach my $sClass (qw( Tk::Wizard::Sizer Tk::Wizard::Installer::Sizer )) {
    ...
    my $s1 =
      "This is the long horizontal text for the Sizer TextFrame Page.  It is wider than the default Wizard width.";
    my $s2 =
"It is stored in a string variable, and a reference to this string variable is passed to the addTextFramePage() method.";
    my $s3 = "This
 is
 the
 long
